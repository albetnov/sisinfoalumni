    ...
    <div class="content transition">
        <div class="container-fluid dashboard">
            ...
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                ...
                <button type="button" class="close" onclick="window.location.href='approval.php';" data-dismiss="alert"
                    aria-label="Close">
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="movedata.php?id=<?php echo $log['id']; ?>"
                                                class="btn btn-success btn-icon"><i class="fas fa-check"></i> Setuju</a>
                                        </td>
                                        <td><a href="hapusreq.php?id=<?php echo $log['id']; ?>"
                                                class="btn btn-danger btn-icon"><i class="fas fa-times"></i> Tolak</a>
                                        </td>
                                        <td><a href="lihatdata.php?id=<?php echo $log['id']; ?>&jenistable=<?php echo $log['jenis_table']; ?>"
                                                class="btn btn-info btn-icon"><i class="fas fa-eye"></i> Lihat</a></td>
                                    </tr>
                                    <?php
									}
									?>
                        ...
                        <a href="movedata.php?id=1092472" class="btn btn-success btn-icon"><i class="fas fa-check"></i>
                            Setujui Semua</a>
                        <a href="hapusreq.php?id=2903482" class="btn btn-danger btn-icon"><i
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="movedataed.php?id=<?php echo $log['id']; ?>"
                                                class="btn btn-success btn-icon"><i class="fas fa-check"></i> Setuju</a>
                                        </td>
                                        <td><a href="hapusreqed.php?id=<?php echo $log['id']; ?>"
                                                class="btn btn-danger btn-icon"><i class="fas fa-times"></i> Tolak</a>
                                        </td>
                                        <td><a href="peekreqed.php?id=<?php echo $log['id']; ?>&jenistable=<?php echo $log['jenis_table']; ?>"
                                                class="btn btn-info btn-icon"><i class="fas fa-eye"></i> Lihat</a></td>
                                    </tr>
                                    <?php
									}
                        ...
                        <a href="../index.php" class="btn btn-primary btn-icon"><i class="fas fa-arrow-left"></i>
                            Kembali</a>
                        <a href="movedataed.php?id=1092472" class="btn btn-success btn-icon"><i
                                class="fas fa-check"></i> Setujui Semua</a>
                        <a href="hapusreqed.php?id=2903482" class="btn btn-danger btn-icon"><i
                                class="fas fa-trash-alt"></i> Hapus Semua</a>
                    </div>
                </div>
            </div>
