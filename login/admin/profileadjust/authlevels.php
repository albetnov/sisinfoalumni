    ...
    <div class="content transition">
        <div class="container-fluid dashboard">
            ...
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                ...
                <button type="button" class="close" onclick="window.location.href='authlevels.php';"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                                ...
                                                <?php if($log['level'] != 'newuser'){ ?>
                                                    <div class="selectdiv">
                                                        <select name="leveling">
                                                            <option value="admin"
                                                                <?php if ($log['level'] == 'admin') : ?>
                                                                selected="selected" <?php endif; ?>>Admin</option>
                                                            <option value="user" <?php if ($log['level'] == 'user') : ?>
                                                                selected="selected" <?php endif; ?>>User</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <?php } ?>
                                        ...
                                        <td class="text-center"><button type="submit" name="submit"
                                                class="btn btn-primary btn-icon"><i class="fas fa-user-edit"></i> Change
                                                Level</button>
                                                </td>
                                        </form>
                                        <td class="text-center"><a class="btn btn-info btn-icon"
                                                href="editprofdata.php?id=<?php echo $log['id']; ?>"><i
                                                    class="fas fa-pen"></i> Edit</a></td>
                                        <td class="text-center"><a class="btn btn-danger btn-icon"
                                                onclick="return confirm('Yakin hapus data?')"
                                                href="hapus.php?id=<?php echo $log['id']; ?>"><i
