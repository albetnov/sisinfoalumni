                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            ...
                            <button type="button" class="close" onclick="window.location.href='kerja.php';"
                        ...
                        <div class="mb-3">
                            <a href="crud/tambah.php" class="btn btn-primary btn-icon"><i class="fas fa-plus"></i>
                                Tambah Data</a>
                            <a href="crud/print.php" class="btn btn-info btn-icon" target="_blank"><i
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($log['gambar'] != "") { ?>
                                        <td><a href="crud/lihat.php?id=<?php echo $log['id']; ?>"><img
                                                    src="crud/gambar/<?php echo $log['gambar']; ?>"
                                                    style="width:50px;"></a></td>
                                        <?php } ?>
                                        <?php if ($log['gambar'] == "") { ?>
                                        <td>Tidak ada gambar</td>
                                        <?php } ?>
                                        <td class="text-center"><a href="crud/edit.php?id=<?php echo $log['id']; ?>"
                                                class="btn btn-warning btn-icon"><i class="fas fa-edit"></i> Edit</td>
                                        <td class="text-center"><a href="crud/hapus.php?id=<?php echo $log['id']; ?>"
