                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            ...
                            <button type="button" class="close" onclick="window.location.href='usaha.php';"
                        ...
                        <div class="mb-3">
                            <a href="crudusaha/tambah.php" class="btn btn-primary btn-icon"><i class="fas fa-plus"></i>
                                Tambah Data</a>
                            <a href="crudusaha/print.php" target="_blank" class="btn btn-info btn-icon"><i
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($log['gambar'] != "") { ?>
                                        <td><a href="crudusaha/lihat.php?id=<?php echo $log['id']; ?>"><img
                                                    src="crudusaha/gambar/<?php echo $log['gambar']; ?>"
                                        ...
                                        <td class="text-center"><a
                                                href="crudusaha/edit.php?id=<?php echo $log['id']; ?>"
                                                class="btn btn-warning btn-icon"><i class="fas fa-edit"></i> Edit</td>
                                        <td class="text-center"><a
                                                href="crudusaha/hapus.php?id=<?php echo $log['id']; ?>"
