                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            ...
                            <button type="button" class="close" onclick="window.location.href='mencrkrj.php';"
                        ...
                        <?php } ?>
                        <div class="mb-3">
                            <a href="crudmencrkrj/tambah.php" class="btn btn-primary btn-icon"><i
                                    class="fas fa-plus"></i> Tambah Data</a>
                            <a href="crudmencrkrj/print.php" target="_blank" class="btn btn-info btn-icon"><i
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($log['gambar'] != "") { ?>
                                        <td><a href="crudmencrkrj/lihat.php?id=<?php echo $log['id']; ?>"><img
                                                    src="crudmencrkrj/gambar/<?php echo $log['gambar']; ?>"
                                        ...
                                        <td class="text-center"><a
                                                href="crudmencrkrj/edit.php?id=<?php echo $log['id']; ?>"
                                                class="btn btn-warning btn-icon"><i class="fas fa-edit"></i> Edit</td>
                                        <td class="text-center"><a
                                                href="crudmencrkrj/hapus.php?id=<?php echo $log['id']; ?>"
                                                class="btn btn-danger btn-icon"
                                                onclick="return confirm('Yakin ingin hapus data?')"><i
                                                    class="fas fa-trash-alt"></i> Hapus</td>
                                    </tr>
                                    <?php
                                    }
                                    ?>
