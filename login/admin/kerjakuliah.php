                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            ...
                            <button type="button" class="close" onclick="window.location.href='kerjakuliah.php';"
                        ...
                        <div class="mb-3">
                            <a href="crudkerkul/tambah.php" class="btn btn-primary btn-icon"><i class="fas fa-plus"></i>
                                Tambah Data</a>
                            <a href="crudkerkul/print.php" class="btn btn-info btn-icon" target="_blank"><i
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($log['gambar'] != "") { ?>
                                        <td><a href="crudkerkul/lihat.php?id=<?php echo $log['id']; ?>"><img
                                                    src="crudkerkul/gambar/<?php echo $log['gambar']; ?>"
                                        ...
                                        <td class="text-center"><a
                                                href="crudkerkul/edit.php?id=<?php echo $log['id']; ?>"
                                                class="btn btn-warning btn-icon"><i class="fas fa-edit"></i> Edit</td>
                                        <td class="text-center"><a
                                                href="crudkerkul/hapus.php?id=<?php echo $log['id']; ?>"
